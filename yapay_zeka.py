...
if menu == "ANA SAYFA":
    ...
    if soru:
        ...
        elif "kaldırmak" in soru: # Lift anlamında
            st.success("Cevap: Kanat altı ve basınç farkıyla oluşan güçlendirme gücüdür.")
        elif "kanat" in soru:
            st.success("Cevap: Taşıma gücünü üreten ana aerodinamik parçadır.")
        else:
            st.warning("Bu terimi henüz öğrenmedim patron!")

elif menu == "PİYASA":
    st.header("💰 Yatırım Takibi")
    st.write("Gram Altın ve Gümüş verileri burada yer alır.")
